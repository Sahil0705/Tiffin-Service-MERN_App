  ...
  return (
    ...
    <table align='right' width="100%" >
        ...
        <td width="90%"><h1 align="left" style={{marginLeft:"2%", display:"inline"}}>Hello! <b>{LoggedInFirstname} {LoggedInLastname}</b></h1></td>
            <td width="5%" align='right'><Button type='button' color='primary' style={{fontSize:"18px", marginRight:"2px", backgroundColor:"purple", color:'white'}} component={Link} to="/Tiffin-Service-MERN_App/Cart">Cart</Button></td>
